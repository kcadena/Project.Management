...
namespace MProjectWPF.DocumentXml
{
    public class WordClass
    {
        ...
        {
            using (WordprocessingDocument document = WordprocessingDocument.Open(pathw, true))
            {
                ...
                RunProperties rpro = new RunProperties();
                rpro.FontSize = new FontSize() { Val = "46" };
        ...
        private void createXps()
        {
            ...
            {
                MessageBox.Show(err.Message + "create");
            }
        ...
        private void loadXps()
        {
            try
            {
                xpsDocument = new XpsDocument(path, FileAccess.Read);
                proPan.docview.Dispatcher.Invoke(DispatcherPriority.Normal, new Action(() =>
                {
        ...
        private void GeneratePartContent(StyleDefinitionsPart part)
        {
            ...
            Languages languages1 = new Languages() { Val = "es-CO", EastAsia = "ja-JP", Bidi = "ar-SA" };
            ...
            LatentStyles latentStyles1 = new LatentStyles() { DefaultLockedState = false, DefaultUiPriority = 99, DefaultSemiHidden = false, DefaultUnhideWhenUsed = false, DefaultPrimaryStyle = false, Count = 373 };
            ...
            dd.Style style1 = new dd.Style() { Type = StyleValues.Paragraph, StyleId = "Normal", Default = true };
            ...
            dd.Style style2 = new dd.Style() { Type = StyleValues.Paragraph, StyleId = "Heading1" };
            ...
            Rsid rsid1 = new Rsid() { Val = "00B05760" };
            ...
            dd.Style style3 = new dd.Style() { Type = StyleValues.Character, StyleId = "DefaultParagraphFont", Default = true };
            ...
            dd.Style style4 = new dd.Style() { Type = StyleValues.Table, StyleId = "TableNormal", Default = true };
            ...
            dd.Style style5 = new dd.Style() { Type = StyleValues.Numbering, StyleId = "NoList", Default = true };
            ...
            dd.Style style6 = new dd.Style() { Type = StyleValues.Character, StyleId = "Heading1Char", CustomStyle = true };
            ...
            Rsid rsid2 = new Rsid() { Val = "00B05760" };
